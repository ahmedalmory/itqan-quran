...
$selected_department = isset($_GET['department_id']) ? (int)$_GET['department_id'] : null;
...
if ($selected_department) {
    $query .= " WHERE sc.department_id = " . $selected_department;
}
        ...
        <div class="col-md-8">
            <form class="d-flex gap-3 align-items-center">
                ...
                <?php if ($selected_department): ?>
                    <a href="?action=new&department_id=<?php echo $selected_department; ?>" class="btn btn-primary">
